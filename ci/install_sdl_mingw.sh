if [ ! -f SDL2_net-2.0.1/README.txt ]; then
    curl https://libsdl.org/release/SDL2-devel-2.0.16-mingw.tar.gz -o SDL2.tar.gz
    ...
    sed -i "s|/opt/local|$PWD/SDL2-2.0.16|g" ./SDL2-2.0.16/x86_64-w64-mingw32/lib/cmake/SDL2/sdl2-config.cmake

    # copy SDL2_image/net into SDL2
    cp -r ./SDL2_image-2.0.5/x86_64-w64-mingw32 ./SDL2-2.0.16/
    cp -r ./SDL2_net-2.0.1/x86_64-w64-mingw32 ./SDL2-2.0.16/
fi
